...
plot(x=(subdata$DateTime),y=subdata$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
plot(subdata$DateTime, subdata$Global_reactive_power, type = "l", main = "", xlab = "datetime", ylab = "Global_reactive_power")
